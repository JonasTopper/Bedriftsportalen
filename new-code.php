...
<body>
    <section> <span></span> <span></span> <span></span> <span></span> <span></span> <span></span> <span></span>
       ...
       <img class="verifiserings-logo" src="Images/logo_no_slogan.png"/>
        <h2>Glemt verifiseringskode</h2> 
        <p class="verification-info">Skriv din email for å få din verifiseringskode</p>
        <form action="Send.php" method="post">
            <div class="inputmails">
                <input class="input-mail" type="email" name="email" required placeholder="Enter your email">
            </div>
                <br>
            <button class="pin-button btn-16" type="submit" name="send">Send</button>
        </form>
        <a href="Verification.php"><p class="verification-info">Returner</p></a>
    </div>
    </div>
    </section>
</body>

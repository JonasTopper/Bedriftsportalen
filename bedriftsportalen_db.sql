...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2024 at 09:06 AM
...
CREATE TABLE `ansatte` (
  ...
  `stilling` int(40) NOT NULL,
  `kontakt_person` tinyint(1) NOT NULL,
  `bedrift_id` int(11) NOT NULL,
  `tlf_nr` int(15) NOT NULL,
...
CREATE TABLE `bruker` (
  `bruker_id` bigint(20) UNSIGNED NOT NULL,
  `brukernavn` varchar(40) NOT NULL,
  `passord` varchar(18) NOT NULL,
...
--
-- Table structure for table `postnummerregister_excel`
--

CREATE TABLE `postnummerregister_excel` (
  `poststed` varchar(4) DEFAULT NULL,
  `postnr` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `postnummerregister_excel`
--

INSERT INTO `postnummerregister_excel` (`poststed`, `postnr`) VALUES
('0001', 'OSLO'),
('0010', 'OSLO'),
('0015', 'OSLO'),
('0018', 'OSLO'),
...
ALTER TABLE `bedrifter`
  ...
  ADD UNIQUE KEY `bedrift_id` (`bedrift_id`);
...
--
ALTER TABLE `ansatte`
  MODIFY `a_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `bruker`
  MODIFY `bruker_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
